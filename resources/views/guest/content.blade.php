<main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container text-center" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <h2>Selamat Datang Di Sijasa Banyuwangi</h2>
            <p> Platform yang memudahkan Anda untuk menyewa lapangan olahraga dan alat di Banyuwangi secara online.  </p>
    ...
    {{-- <section id="what-we-do" class="what-we-do section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Tentang Kami</h2>
        <p>Penjelasan Terkait Website Sijasa</p>
      ...
      <div class="container">
        ...
        <div class="row gy-3">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="{{ asset('assets/SIJASAS.png')}}" alt="" class="img-fluid">
          </div>

          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="about-content ps-0 ps-lg-3">
              <h3>Website Sijasa Banyuwangi.</h3>
              <p class="fst-italic">
                Platform yang memudahkan Anda untuk menyewa lapangan olahraga dan alat di Banyuwangi secara online. 
                Baik untuk futsal, basket, voli, atau kegiatan olahraga lainnya, Anda bisa mencari dan memesan lapangan 
                serta peralatan dengan cepat dan mudah. Dapatkan informasi ketersediaan, harga, dan fasilitas langsung 
    ...
    <section id="services" class="services section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Kategori</h2>
        <p>Tempat atau Fasilitas Apa Saja Yang Dapat Disewa</p>
      </div><!-- End Section Title -->
    ...
    <section id="portfolio" class="portfolio section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Fasilitas</h2>
        <p>Beberapa Fasilitas Yang Bisa Disewa Di Masing-Masing Kategori</p>
      </div><!-- End Section Title -->
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('assets/gambar/dispora (1).png') }}" class="testimonial-img" alt="">
                <h3>Dispora</h3>
                {{-- <h4>Ceo &amp; Founder</h4>
                <div class="stars">
                ...
                <p>
                  ...
                  <span>Dispora sebagai wadah yang menjembatani masyarakat untuk peminjaman sarana dan prasarana melalui website sijasa.</span>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('assets/gambar/bwi.png') }}" class="testimonial-img" alt="">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>Kabupaten Banyuwangi sebagai pendukung dengan adanya website booking tempat penyewaan yang ada di banyuwangi.</span>
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
